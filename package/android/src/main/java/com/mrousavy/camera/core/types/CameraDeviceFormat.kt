...
data class CameraDeviceFormat(
  ...
  val minISO: Double,
  val maxISO: Double,
  val minExposureDuration: Double,
  val maxExposureDuration: Double,
  ...
  companion object {
    fun fromJSValue(value: ReadableMap): CameraDeviceFormat {
      ...
      return CameraDeviceFormat(
        ...
        if (value.hasKey("minExposureDuration")) value.getDouble("minExposureDuration") else 0.0,
        if (value.hasKey("maxExposureDuration")) value.getDouble("maxExposureDuration") else 0.0,
